 ...
 */
public class ManageAnimation<T extends Component> implements Runnable {
     ...
     */
    public ManageAnimation(T objeto) {
        this.objeto = objeto;
     ...
     */
    public ManageAnimation<T> addAnimation(int x, int y, int rep, int rate) {
        currentRate = rate;
     ...
     * @return retorna este mismo método.
     */
    public ManageAnimation<T> addAnimation(int x, int y, int rep) {
        anilist.add(new Animation(new Point(x, y), rep, currentRate));
        return this;
    }
